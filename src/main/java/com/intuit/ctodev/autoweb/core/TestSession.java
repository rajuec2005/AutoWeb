...
import com.intuit.ctodev.autoweb.listeners.EventFiringWebDriverListener;
...
public class TestSession {
	...
	public static void start() {
		...
		try {
			...
			if(TestConfigReader.getIsEventFiringWebDriver().equalsIgnoreCase("true")){
				System.out.println("Event Firing Web Driver enabled");
				WebDriver driver = new RemoteWebDriver(url, capability);
				EventFiringWebDriver efwd = new EventFiringWebDriver(driver);
				EventFiringWebDriverListener eventListener = new EventFiringWebDriverListener(driver);
				efwd.register(eventListener);
				put(WEBDRIVER, efwd);
			}
			
			else{
			System.out.println("Event Firing Web Driver disabled");
			WebDriver driver = new RemoteWebDriver(url, capability);
